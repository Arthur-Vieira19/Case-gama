...
import static br.casegamamyapp.domain.MetaAsserts.*;
import static br.casegamamyapp.web.rest.TestUtil.createUpdateProxyForBean;
...
import br.casegamamyapp.domain.enumeration.AreaDoEnem;
import br.casegamamyapp.repository.MetaRepository;
import br.casegamamyapp.service.dto.MetaDTO;
import br.casegamamyapp.service.mapper.MetaMapper;
...
class MetaResourceIT {
    ...
    void partialUpdateMetaWithPatch() throws Exception {
        ...
        partialUpdatedMeta.materia(UPDATED_MATERIA);
